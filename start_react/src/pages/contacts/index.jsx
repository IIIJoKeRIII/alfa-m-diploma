    ...
    return (
        <div className="page-container page-container-medium contacts-page">
            ...
            <p className="contacts-intro">
                Ниже — демонстрационные реквизиты (цифры-заглушки), как просили
                для публичной версии. Телефон и e-mail для деловой переписки не
                указаны. Форма обращения учебная (без отправки на сервер).
            </p>
            <div className="contacts-layout">
                <div className="contacts-block">
                    ...
                    <p className="contacts-source">
                        Условная ссылка для макета:{" "}
                        <a
                            href={company.demoReferenceUrl}
                            target="_blank"
                            rel="noreferrer"
                        >
                            example.com
                ...
                <div className="contacts-block">
                    ...
                    {submitted && (
                        <div className="form-success" role="status">
                            Сообщение принято (демо). В рабочей версии здесь был
                            бы запрос к API или почтовый шлюз.
                        </div>
                    )}
                    <form
