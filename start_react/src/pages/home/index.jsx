    ...
    <div className="home">
      ...
      <section className="home-section page-container page-container-big">
        ...
        <p className="home-disclaimer">
          Сведения на странице носят ознакомительный характер. Для юридически
          значимых целей используйте выписку из ЕГРЮЛ и учётные документы
          организации.
        </p>
        <p className="home-source">
          Дополнительная справка по открытым данным:{' '}
          <a href={company.referenceInfoUrl} target="_blank" rel="noreferrer">
            внешний информационный ресурс
          </a>
          .
        </p>
      </section>
